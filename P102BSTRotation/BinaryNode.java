...
/**
 * This class represents a node for a Binary Search Tree that holds a single data value and is
 * doubly linked: has a reference to its parent node and two references to its children nodes.
 */
public class BinaryNode<T> {
  ...
  /**
   * Constructor that creates a new node with the value data. Both parent and child references of
   * the new node are initialized to null.
   *
  ...
  /**
   * @return the reference to the left child of this node, or null if this node has no left child
   */
  public BinaryNode<T> downLeft() {
    return this.left;
  }

  /**
   * @return the reference to the right child of this node, or null if this node has no right child
   */
  public BinaryNode<T> downRight() {
    return this.right;
  }

  /**
   * @return the reference to the parent of this node, or null if it has no parent
   */
  public BinaryNode<T> up() {
    return this.up;
  }
   ...
   */
  public void setEntry(T newData) {
    this.entry = newData;
  }
   ...
   */
  public void setUp(BinaryNode<T> newParent) {
    this.up = newParent;
  }
  ...
  /**
   * Performs an level-order traversal of the subtree rooted at this node and generates a string
   * represeation of those nodes' contents.
   *
  ...
  /**
   * Performs an in-order traversal of the subtree rooted at this node and generates a string
   * representation of those nodes' contents.
   *
