...
import { n as init_babel, parsers as Aa, t as babel_exports } from "./babel-HneeYPAt.js";
import index_exports, { t as init_prettier } from "./prettier-DOXWZfW7.js";
import { a as __toESM$1, t as __commonJSMin } from "./chunk-DSjvVL_1-BJd7wpp8.js";
import { a as sortClasses, c as cacheForDirs, d as expiringMap, f as loadIfExists, i as sortClassList, l as spliceChangesIntoString, n as error, o as warn, p as maybeResolve, r as getTailwindConfig$1, u as visit } from "./sorter-BZkvDMjt-DFk5bI-C.js";
...
const { parsers, printers } = createPlugin([
	...
	defineTransform({
		...
		parsers: {
			...
			flow: { load: [{
				...
				importer: () => import("./flow-CfSVIsZI.js")
			}] },
			oxc: { load: [{
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./plugin-Cg3MUYFL.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))
		}],
		parsers: { svelte: {} },
		printers: { "svelte-ast": {} },
