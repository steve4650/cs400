...
/**
 * This is a placeholder for the fully working Tree that will be developed in a future week. It is
 * designed to help develop and test the functionality of Backend code for Project1. Note the
...
public class Tree_Placeholder implements IterableSortedCollection<GameRecord> {
  ...
  public void setIteratorMin(Comparable<GameRecord> min) {
    this.min = min;
  }

  public void setIteratorMax(Comparable<GameRecord> max) {
    this.max = max;
  }
